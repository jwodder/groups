...
__all__ = ["Group", "Element", "Cyclic", "Semidirect", "DirectProduct",
	   "Dicyclic", "Quaternion", "Dihedral", "Trivial", "Klein4",
	   "AutCyclic", "HolCyclic", "CycSemiCyc", "Symmetric", "closure",
	   "getGroup"]
...
class Group(object):
    ...
    def LaTeX(self,x):     raise NotImplementedError
...
class DirectProduct(Semidirect):
    ...
    # LaTeXElem are inherited from semidirect (though the last two might have
...
class AutCyclic(Group):  # formerly "MultiplicN"
    ...
    def LaTeXElem(self,x): return r'\cdot{}' + x.i.LaTeX()  if x else  '1'
